...
y_pred_hard = vot_hard.predict(X_valid)

vot_soft = VotingClassifier(estimators = estimator, voting ='soft')
vot_soft.fit(X_train, Y_train)
y_pred_soft = vot_soft.predict(X_valid)
...
score_hard = accuracy_score(Y_vaild, y_pred_hard)
print(" ======================================================== ")
print("| [Stage 4]: Model Evaluation                            |")
print("| Accuracy hard:", score_hard*100, '%                     |')
print(" ======================================================== ")

score_soft = accuracy_score(Y_vaild, y_pred_soft)
print(" ======================================================== ")
print("| [Stage 4]: Model Evaluation                            |")
...
if old_hard_accuracy == new_hard_accuracy:
  with open('models/hard_voting.hdf5', 'wb') as file:
...
if old_soft_accuracy == new_soft_accuracy:
  with open('models/soft_voting.hdf5', 'wb') as file:
